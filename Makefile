...
MODULE_big = pg_shard
OBJS = connection.o copy_shard.o create_shards.o citus_metadata_sync.o \
	   distribution_metadata.o extend_ddl_commands.o generate_ddl_commands.o \
	   pg_shard.o prune_shard_list.o repair_shards.o ruleutils.o
